...
flowchart TD
    ...
    D --> E
```
Note: The execution flow chart shows that the script can start with any of the three functions, and each function will execute independently. The `End` node represents the completion of the function execution.