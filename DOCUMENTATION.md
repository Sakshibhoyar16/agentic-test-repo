...
flowchart TD
    ...
    D --> E
```
Note: The execution flow chart shows that the script starts at the beginning and can execute any of the three functions (`add`, `sub`, `mul`) before reaching the end. 
