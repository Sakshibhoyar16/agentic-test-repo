...
### Module-Level Code
When run directly, this script does not have any specific behavior, as it only contains function definitions. To use the functions, you would need to call them explicitly, as shown in the example usage sections above.