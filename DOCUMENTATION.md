...
flowchart TD
    ...
    D --> E
```
When run directly, the script does not have any specific functionality as it only contains function definitions. To use these functions, you would need to call them from another script or interactively.