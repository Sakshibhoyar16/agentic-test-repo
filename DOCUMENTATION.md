...
### Module-Level Code
When run directly, this script does not contain any module-level code, so there is no specific behavior to describe. The functions can be imported and used in other scripts as needed.