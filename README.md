...
When run directly, the calculator.py script does not contain any module-level code, such as print statements or main blocks, that would execute automatically.
