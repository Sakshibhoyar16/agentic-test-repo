...
flowchart TD
    ...
    D --> E
```
When run directly, this script does not execute any specific code, as it only defines functions. To use these functions, import the calculator.py file in another script and call the desired functions.
