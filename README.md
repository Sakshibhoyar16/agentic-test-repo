...
When run directly, the script does not have a main block or any print statements, so it does not perform any specific actions beyond providing the mathematical functions for use in other scripts.
