...
flowchart TD
    ...
    D --> E
```
Note: This flowchart shows that the execution flow can start with any of the three functions (`add`, `sub`, or `mul`) and ends after the function has been executed. 
