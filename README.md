...
flowchart TD
    ...
    D --> E
```
When run directly, the `calculator.py` script does not contain any module-level code, so it will not perform any actions without being imported and used by another script.
