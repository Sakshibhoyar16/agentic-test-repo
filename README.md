...
### Module-Level Code
When run directly, this script does not have any module-level code that executes. It only defines the `add`, `sub`, and `mul` functions for use in other scripts.
