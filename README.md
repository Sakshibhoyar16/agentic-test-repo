...
flowchart TD
    ...
    D --> E
```
Note: This flowchart shows that the execution can start with any of the three functions (`add`, `sub`, or `mul`) and then ends after the function execution is completed. 
