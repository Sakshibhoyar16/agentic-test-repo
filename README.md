...
flowchart TD
    ...
    D --> E
```
This script can be used to perform basic arithmetic operations when run directly. It does not include any module-level code, so no further description is required.
