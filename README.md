...
flowchart TD
    ...
    D --> E
```
When run directly, this script does not have a main block or any module-level code that executes. It is meant to be used as a module, importing the functions as needed.
